...
onMounted(() => {
  fetchDashboardData(), getResidentStatistic()
})
</script>
      ...
      <div id="Date-Picker" class="flex flex-col gap-4 p-6">
        ...
        <div class="flex justify-between">
          <button class="group flex flex-col items-center w-[46px] h-[76px] shrink-0 gap-3">
            ...
            >
              <span class="font-medium text-desa-dark-green group-[.active]:text-white"> 28 </span>
            </div>
          ...
          <button class="group flex flex-col items-center w-[46px] h-[76px] shrink-0 gap-3">
            <div
              class="flex rounded-full size-[46px] items-center justify-center bg-desa-foreshadow group-[.active]:bg-desa-soft-green"
            >
              <span class="font-medium text-desa-dark-green group-[.active]:text-white"> 29 </span>
            </div>
            <span class="font-medium text-sm text-desa-secondary group-[.active]:text-desa-black">
              Sel
            </span>
          ...
          <button class="group flex flex-col items-center w-[46px] h-[76px] shrink-0 gap-3">
            <div
              class="flex rounded-full size-[46px] items-center justify-center bg-desa-foreshadow group-[.active]:bg-desa-soft-green"
            >
              <span class="font-medium text-desa-dark-green group-[.active]:text-white"> 30 </span>
            </div>
            <span class="font-medium text-sm text-desa-secondary group-[.active]:text-desa-black">
              Rab
            </span>
          ...
          <button class="group flex flex-col items-center w-[46px] h-[76px] shrink-0 gap-3 active">
            <div
              class="flex rounded-full size-[46px] items-center justify-center bg-desa-foreshadow group-[.active]:bg-desa-soft-green"
            >
              <span class="font-medium text-desa-dark-green group-[.active]:text-white"> 31 </span>
            </div>
            <span class="font-medium text-sm text-desa-secondary group-[.active]:text-desa-black">
              Kam
            </span>
