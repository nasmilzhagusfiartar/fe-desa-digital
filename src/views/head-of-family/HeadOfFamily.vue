  ...
  <div id="Header" class="flex items-center justify-between">
    <div class="flex flex-col gap-2">
      <div class="flex gap-1 items-center leading-5 text-desa-secondary">
        ...
        <span>/</span>
        <p class="last-of-type:text-desa-dark-green last-of-type:font-semibold capitalize">
          Manage Kepala Keluarga
        </p>
      </div>
      <h1 class="font-semibold text-2xl">Manage Kepala Keluarga</h1>
    </div>
    <button
  ...
  <div class="flex gap-[14px]">
    <div class="flex flex-col w-[calc(525/1000*100%)] shrink-0 gap-[14px]">
      <section id="Kepala-Rumah" class="flex flex-col rounded-3xl p-6 gap-6 bg-white">
        <p class="font-medium leading-5 text-desa-secondary">Kepala Keluarga</p>
        ...
        <div class="flex items-center w-full gap-3">
          ...
          <div class="flex flex-col gap-1 w-full">
            ...
            <span class="font-medium text-desa-secondary"> Umur Kepala Keluarga </span>
          </div>
        </div>
        <hr class="border-desa-foreshadow" />
        <div class="flex items-center w-full gap-3">
      ...
      >
        ...
        <div class="flex flex-col gap-[14px]">
          <div
            ...
            v-for="(familyMember, index) in headOfFamily.family_members"
            :key="index"
          >
            <div class="flex items-center gap-4">
              <div
